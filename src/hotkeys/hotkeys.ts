...
const baseSections: HotkeySection[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { key: 'PageUp / PageDown', action: 'Scroll transcript by page' },
      { key: 'Ctrl+PageUp / Ctrl+PageDown', action: 'Scroll transcript by line' },
      { key: 'Ctrl/Cmd+↑ / Ctrl/Cmd+↓', action: 'Scroll transcript to top or bottom' },
